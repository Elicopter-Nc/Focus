...
```bash
git clone https://github.com/Elicopter-Nc/Focus.git
cd Focus
chmod +x install.sh
./install.sh
```
...
* Ajouter l'app au menu des applications
...
> Double-clique sur `install.bat` ou lance le depuis le terminal.
